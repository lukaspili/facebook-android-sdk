    ...
    public static Bundle create(
        ...
        if (shareContent instanceof ShareLinkContent) {
            ...
            final ShareStoryContent storyContent =
                (ShareStoryContent) shareContent;
            Bundle mediaInfo =
                ShareInternalUtility.getBackgroundAssetMediaInfo(storyContent, callId);
            Bundle stickerInfo =
                ShareInternalUtility.getStickerUrl(storyContent, callId);
            nativeParams =
                create(storyContent, mediaInfo, stickerInfo, shouldFailOnDataError);
        }
