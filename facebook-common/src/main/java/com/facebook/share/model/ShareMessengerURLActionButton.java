...
public final class ShareMessengerURLActionButton extends ShareMessengerActionButton {
    ...
    public static final class Builder
        ...
        /**
         * Set the fallback URL for a Messenger Extensions enabled button. This is a fallback url
         * for a Messenger Extensions enabled button. It is used on clients that do not support
         * Messenger Extensions. If this is not defined, the url will be used as a fallback.
         * Optional, but ignored unless messengerExtensions == YES.
         */
         ...
         * This controls the display height of the webview when shown in the Messenger app.
         * Defaults to Full
         */
        ...
        /**
         * Set whether we want to hide the share button in the webview or not. This controls whether
         * we want to hide the share button in the webview or not. It is useful to hide the share
         * button when the webview is user-specific and contains sensitive information
         * Defaults to NO.
         */
